...
export default {
  ...
  methods: {
    SendRequest() {
      ...
      if (!this.v$.$error) {
        ...
        SLoginService.PostResetPassword(payload)
          .then((response) => {
            if (response.data.detail?.isDone) {
              ...
              setTimeout(() => {
                this.$router.push("/students/signin");
              }, 1500);
            } else {
  ...
  beforeCreate() {
    document.title = "Student Forgot Password | " + this.SiteTitle;
  },
};
</script>
<template>
              ...
              <div class="row">
                <div class="col-md-7">
                  ...
                  <div class="login-footer fw-500">
                    ...
                    <router-link to="/students/signup" class="text-primary"
